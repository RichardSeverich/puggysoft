...
function CursoGenericTable (props) {
  ...
  const { value: criteriaGestion, onChange: criteriaOnChangeGestion, setValue: criteriaSetGestion } = useInput("");
  ...
  const { value: operatorGestion, onChange: operatorOnChangeGestion, setValue: operatorSetGestion } = useInput(enumCompareOperators.TEXT_CONTAINS);
...
export default CursoGenericTable;

CursoGenericTable.propTypes = {

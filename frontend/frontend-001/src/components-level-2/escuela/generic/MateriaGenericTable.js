...
import tableModel from "../../../models/escuela/materiaTableModels";

function MateriaGenericTable (props) {
  const {
    numberPagesToShow,
    tableTitle,
    tableSubTitle,
  ...
  const { value: criteriaNotaMaxima, onChange: criteriaOnChangeNotaMaxima, setValue: criteriaSetNotaMaxima } = useInput("");
  ...
  const { value: operatorNotaMaxima, onChange: operatorOnChangeNotaMaxima, setValue: operatorSetNotaMaxima } = useInput(enumCompareOperators.TEXT_CONTAINS);
  ...
  const { arrayColumnsFilter, clearFilters, getFilterBody, arrayColumnsLabels, arrayDataFields } = tableModel(
    ...
    /* NOTA MAXIMA */criteriaNotaMaxima, criteriaOnChangeNotaMaxima, criteriaSetNotaMaxima, operatorNotaMaxima, operatorOnChangeNotaMaxima, operatorSetNotaMaxima,
...
export default MateriaGenericTable;

MateriaGenericTable.propTypes = {
...
MateriaGenericTable.defaultProps = {
  numberPagesToShow: 0,
  tableTitle: "",

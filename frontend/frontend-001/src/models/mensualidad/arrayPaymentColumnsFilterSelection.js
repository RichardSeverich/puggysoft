...
const getColumnsFilterModel = function (
  ...
  let filterObjectSaleStatus = {
    ...
    dropdownValues: [
      ...
      { value: enumPaymentStatus.TODO, text: i18n.saleStatus.todo },
      { value: enumPaymentStatus.IN_PROGRESS, text: i18n.saleStatus.inProgress },
      { value: enumPaymentStatus.DONE, text: i18n.saleStatus.done }
    ]
  };

  if (criteriaStatusDefault === enumPaymentStatus.TODO) {
    filterObjectSaleStatus = {
      type: enumFilterType.NONE
    };
  } else if (criteriaStatusDefault === enumPaymentStatus.IN_PROGRESS) {
    filterObjectSaleStatus = {
      type: enumFilterType.NONE
    };
  }

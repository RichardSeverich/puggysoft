...
const tableFilter = function (
  ...
  /* NOTA MAXIMA */criteriaNotaMaxima, criteriaOnChangeNotaMaxima, operatorNotaMaxima, operatorOnChangeNotaMaxima,
  ...
  const arrayColumnsFilter = [
    ...
    {
      type: enumFilterType.NUMBER,
      criteriaValue: criteriaNotaMaxima,
      criteriaOnchange: criteriaOnChangeNotaMaxima,
      operatorValue: operatorNotaMaxima,
      operatorOnchange: operatorOnChangeNotaMaxima
    },
    {
      type: enumFilterType.TEXTBOX,

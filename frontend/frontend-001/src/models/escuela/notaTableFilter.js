...
const tableFilter = function (
  ...
  /* PORCENTAJE */criteriaPorcentaje, criteriaOnChangePorcentaje, operatorPorcentaje, operatorOnChangePorcentaje,
  ...
  const arrayColumnsFilter = [
    ...
    {
      type: enumFilterType.NUMBER,
      criteriaValue: criteriaPorcentaje,
      criteriaOnchange: criteriaOnChangePorcentaje,
      operatorValue: operatorPorcentaje,
      operatorOnchange: operatorOnChangePorcentaje
    },
    {
      type: enumFilterType.TEXTBOX,

...
import alcaldiaRecursosMunicipalesFoldersColumnsFilter from "./alcaldiaRecursosMunicipalesFoldersColumnsFilter";
import i18n from "../../i18n/i18n";

const alcaldiaRecursosMunicipalesFoldersTableModels = function (
  tableColumnsToShow,
  ...
  let arrayColumnsFilter = alcaldiaRecursosMunicipalesFoldersColumnsFilter(
  ...
  const getFilterBody = () => {
    ...
    const filterBody = {
      ...
      nameCriteria: i18n.alcaldiaRecursosMunicipalesFoldersForm.defaultFolder,
      nameOperator: enumCompareOperators.TEXT_CONTAINS,
      nameAuxCriteria: criteriaName,
      nameAuxOperator: operatorName,
...
export default alcaldiaRecursosMunicipalesFoldersTableModels;

...
import arrayDataFieldsImport from "./alcaldiaRecursosMunicipalesFoldersVentasDataFields";
import arrayColumnsLabelsImport from "./alcaldiaRecursosMunicipalesFoldersVentasColumnsLabels";
import alcaldiaRecursosMunicipalesFoldersVentasColumnsFilter from "./alcaldiaRecursosMunicipalesFoldersVentasColumnsFilter";

const alcaldiaRecursosMunicipalesFoldersVentasTableModels = function (
  tableColumnsToShow,
  /* ID */ criteriaId,
  criteriaOnChangeId,
  criteriaSetId,
  ...
  let arrayColumnsFilter = alcaldiaRecursosMunicipalesFoldersVentasColumnsFilter(
    /* ID */ criteriaId,
    criteriaOnChangeId,
    operatorId,
    operatorOnChangeId,
...
export default alcaldiaRecursosMunicipalesFoldersVentasTableModels;

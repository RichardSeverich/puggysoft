...
// MENSUALIDAD SYSTEM
const MENSUALIDAD_COLEGIATURAS_MATRICULAS_FORM = "/mensualidad-colegiaturas-matriculas-form";
const MENSUALIDAD_COLEGIATURAS_MATRICULAS_TABLE = "/mensualidad-colegiaturas-matriculas-table";
const MENSUALIDAD_PROGRAMA_POSTGRADO_FORM = "/mensualidad-programa-postgrado-form";
const MENSUALIDAD_PROGRAMA_POSTGRADO_CURSO_FORM = "/mensualidad-programa-postgrado-curso-form";
const MENSUALIDAD_PROGRAMA_POSTGRADO_CURSO_TABLE = "/mensualidad-programa-postgrado-curso-table";
const MENSUALIDAD_PROGRAMA_POSTGRADO_TABLE = "/mensualidad-programa-postgrado-table";
const MENSUALIDAD_ASSIGN_COLEGIATURA_MATRICULA_STEP1 = "/mensualidad-assign-colegiatura-matricula-step1";
const MENSUALIDAD_ASSIGN_COLEGIATURA_MATRICULA_STEP2 = "/mensualidad-assign-colegiatura-matricula-step2";
...
const enumPaths = {
  ...
  // MENSUALIDAD SYSTEM
  MENSUALIDAD_COLEGIATURAS_MATRICULAS_FORM,
  MENSUALIDAD_COLEGIATURAS_MATRICULAS_TABLE,
  MENSUALIDAD_PROGRAMA_POSTGRADO_FORM,
  MENSUALIDAD_PROGRAMA_POSTGRADO_CURSO_FORM,
  MENSUALIDAD_PROGRAMA_POSTGRADO_CURSO_TABLE,
  MENSUALIDAD_PROGRAMA_POSTGRADO_TABLE,
  MENSUALIDAD_ASSIGN_COLEGIATURA_MATRICULA_STEP1,
  MENSUALIDAD_ASSIGN_COLEGIATURA_MATRICULA_STEP2,
  // HOSPITAL SYSTEM

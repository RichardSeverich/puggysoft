...
// MENSUALIDADES SYSTEM
const MENSUALIDADES_COLEGIATURAS_MATRICULAS_FORM = "/mensualidades-colegiaturas-matriculas-form";
const MENSUALIDADES_COLEGIATURAS_MATRICULAS_TABLE = "/mensualidades-colegiaturas-matriculas-table";
...
const enumPaths = {
  ...
  // MENSUALIDADES SYSTEM
  MENSUALIDADES_COLEGIATURAS_MATRICULAS_FORM,
  MENSUALIDADES_COLEGIATURAS_MATRICULAS_TABLE,
  // HOSPITAL SYSTEM

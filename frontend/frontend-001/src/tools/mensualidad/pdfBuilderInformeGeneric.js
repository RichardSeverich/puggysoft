...
const GeneratePdf = async (data) => {
  ...
  doc.setFontSize(15);
  doc.text(i18n.HistoryPorEstudianteCursoTable.tableTitlePdfCourse, 50, 29);
  ...
  doc.setFontSize(10);
  doc.text(
    `${i18n.HistoryPorEstudianteCursoTable.statePaymentsCourse}`,
    (lineVerticalX / 2) + 15,
    51,
    {
      align: "center",
  ...
  doc.text(
    `${i18n.HistoryPorEstudianteCursoTable.urgentCourse}`,
    (lineVerticalX / 2) + 15,
    59,
    {
      align: "center",
  ...
  doc.autoTable({
    ...
    willDrawCell: function (data) {
      const dataToRed = (data.column.dataKey === 5) ||
